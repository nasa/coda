...
import { GPXTracks_db, MediaOverride_db } from "./src/server/database/models/_allModels";
...
export default defineConfig({
  ...
  entitiesTs: [GPXTracks_db, MediaOverride_db],
  entities: [GPXTracks_db, MediaOverride_db],
